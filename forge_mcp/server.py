...
from forge_mcp.characters import CharacterStore; from forge_mcp.prompts import PromptStore
...
ctx = types.SimpleNamespace(
    ...
    characters=CharacterStore(cfg.results_root), prompts=PromptStore(cfg.results_root),
